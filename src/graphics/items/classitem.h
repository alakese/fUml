...
class ClassItem : public QGraphicsObject
{
    ...
    /* Display options*/
    qint8 m_displayOptions;
    /* If an association item will be created, then the class item shall not move */
    bool m_bMoveResize;
    /* If this class item will be resized, then send a signal to asso-items */
    bool m_bSendItemResSigToAssoItems;
...
public:
    ...
    QPointF getTopRightPos();
    QPointF getBottomLeftPos();
    QPointF getBottomRightPos();
    bool canMoveResize() const;
    void setMoveResize(bool);
...
signals:
    ...
    void itemMoving(ClassItem *);
    void itemResizing(ClassItem *);
